...
public class SimpleTest2 extends AbstractTest{
    ...
    public void getRec(){
        ...
        Solution.athleteJoinSport(1, 200);
        Solution.athleteJoinSport(1, 300);
        ...
        assertEquals(list.get(4), 200);
        assertEquals(list.get(5), 300);

        list = Solution.getSportsRecommendation(1);
        for(int i = 0; i < list.size(); i++ ){
            System.out.println("List pos " + i + " value: " + list.get(i));
        }
        assertEquals(list.get(0), 200);
        assertEquals(list.get(1), 300);
