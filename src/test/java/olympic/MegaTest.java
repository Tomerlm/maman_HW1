...
public class MegaTest extends AbstractTest {
    ...
    public void Test_1_Basic() {
        ...
        assertEquals(200, Solution.getIncomeFromSport(s.getId()).intValue());
    ...
    public void Test_2_Basic() {
        ...
        assertNotEquals(100, Solution.getIncomeFromSport(1).intValue());
        assertNotEquals(ReturnValue.OK, Solution.confirmStanding(12,1,1));
        assertNotEquals(ReturnValue.NOT_EXISTS, Solution.confirmStanding(1,2,1));
        assertNotEquals(1, Solution.getTotalNumberOfMedalsFromCountry("israel").intValue());
        assertTrue(Solution.getBestCountry().contains("israel"));
        assertNotEquals(ReturnValue.OK, Solution.athleteDisqualified(1,2));
        assertTrue(Solution.getBestCountry().contains("israel"));
        assertNotEquals(ReturnValue.OK, Solution.athleteDisqualified(12,1));
        assertEquals("", Solution.getBestCountry());
        assertNotEquals(ReturnValue.OK, Solution.confirmStanding(12,1,1));   // disqualified athletes can get medals
        Solution.athleteJoinSport(12,3);
        Solution.athleteJoinSport(2,3);
        Solution.confirmStanding(12,3,1);
        Solution.confirmStanding(2,3,2);
        assertNotEquals(1, Solution.getTotalNumberOfMedalsFromCountry("canada").intValue());
        assertTrue(Solution.getBestCountry().contains("canada"));
        assertTrue(Solution.getMostPopularCity().contains("tel-aviv"));
        assertNotEquals(ReturnValue.OK, Solution.deleteAthlete(Solution.getAthleteProfile(1)));
        assertNotEquals(ReturnValue.NOT_EXISTS, Solution.athleteLeftSport(12,1)); // should have been deleted on previous test
